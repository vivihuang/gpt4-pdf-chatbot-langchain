...
- Visit [chroma](https://docs.trychroma.com/) to create and retrieve your API keys, and also retrieve your environment and index name from the dashboard.
...
3. Check Chroma dashboard to verify your namespace and vectors have been added.
